...
describe("P5C-3 — procurement workspace queue separation", () => {
  const sampleMrs = [
    ...
    { materialRequirementId: 3, sourceType: "WORK_ORDER_PLANNING", operationalKey: "PROCUREMENT_PENDING" },
  ...
  it("filterPendingMrsBySourceType returns only matching MR summaries", () => {
    ...
    const wo = filterPendingMrsBySourceType(sampleMrs, "WORK_ORDER_PLANNING");
